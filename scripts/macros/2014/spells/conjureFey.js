...
async function use({workflow}) {
    ...
    let compendiumDocs = await compendiumUtils.getFilteredActorDocumentsFromCompendium(monsterCompendium, {maxCR: spellLevel, actorTypes: ['npc'], creatureTypes: ['fey', 'beast']});
