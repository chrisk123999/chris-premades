...
async function use({workflow}) {
    ...
    let compendiumDocs = await compendiumUtils.getFilteredActorDocumentsFromCompendium(monsterCompendium, {maxCR: selection, actorTypes: ['npc'], creatureTypes: ['elemental']});
