...
async function celerity(workflow) {
...
async function mobility(workflow) {
    let classLevels = workflow.actor.classes['blood-hunter']?.system?.levels;
    if (!classLevels) return;
    let effectData = {
...
async function potency(workflow) {
    let classLevels = workflow.actor.classes['blood-hunter']?.system?.levels;
    if (!classLevels) return;
    let effectData = {
...
async function rapidity(workflow) {
    let classLevels = workflow.actor.classes['blood-hunter']?.system?.levels;
    if (!classLevels) return;
    let effectData = {
...
async function sagacity(workflow) {
    let classLevels = workflow.actor.classes['blood-hunter']?.system?.levels;
    if (!classLevels) return;
    let effectData = {
...
async function createMutagen(workflow) {
    let generatedMenu = [];
...
async function strangeMetabolism(workflow) {
