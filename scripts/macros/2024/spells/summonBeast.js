...
async function use({workflow}) {
        ...
        actor: {
            ...
            system: {
                ...
                attributes: {
                    ...
                    movement: {
                        walk: genericUtils.convertDistance(30)
                    }
                }
            },
            prototypeToken: {
    ...
    if (creatureType === 'air') {
        ...
        updates.actor.system.attributes.movement.fly = genericUtils.convertDistance(60);
    } else {
        ...
        if (creatureType === 'land') {
            updates.actor.system.attributes.movement.climb = genericUtils.convertDistance(30);
        } else {
            updates.actor.system.attributes.movement.swim = genericUtils.convertDistance(30);
