...
- Added Generic: damageBonusToOneRoll, passiveAura, hide, pushOnFail, teleport
- Improved Generic: preventDeath gains saveActivity, dcFromDamage, excludeCritical, excludeDamageTypes
## Bug Fixes:
- Brutal Strike
...
- Eldritch Invocations: Eldritch Smite
...
- Eldritch Invocations: Maddening Hex
...
- Elemental Gift (Dao, Djinni, Efreeti, Marid)
- Genie's Vessel: Genie's Wrath (Dao, Djinni, Efreeti, Marid)
- Form of the Beast
